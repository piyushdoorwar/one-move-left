# One Move Left - Game Rules

## Overview
"One Move Left" is a tile-matching puzzle game where players swipe to move tiles on a 6x6 grid, aiming to create chains of matching tiles that pop in neon chain reactions. The game features limited moves per level, with goals that must be completed before moves run out. Levels increase in difficulty as you progress.
